...
async function renderNew() {
  const [instructions, invoices, bookings, reviews] = await Promise.all([repository.instructions(), repository.invoices(), repository.bookings(), repository.reviews()]);
